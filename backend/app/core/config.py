...
class Settings(BaseSettings):
    ...
    deepseek_planner_model: str = Field(default="deepseek-chat", alias="DEEPSEEK_PLANNER_MODEL")
    ...
    agentic_rag_max_rounds: int = Field(default=4, alias="AGENTIC_RAG_MAX_ROUNDS")
    agentic_rag_max_tool_calls_per_round: int = Field(default=5, alias="AGENTIC_RAG_MAX_TOOL_CALLS_PER_ROUND")
