...
from app.api.v1.routes import analysis, analysis_skills, cases, document_mother, graph, health, ingestion, legal_knowledge, memories, reports
...
api_router.include_router(document_mother.router, prefix="/cases", tags=["document-mother"])
...
api_router.include_router(analysis_skills.router, tags=["analysis-skills"])
